...
WebUI.click(findTestObject('Object Repository/OrangeHRM/Page_OrangeHRM/a_Recruitment'))

//WebUI.click(findTestObject('Object Repository/OrangeHRM/Page_OrangeHRM/span_Thanh Vo'))
